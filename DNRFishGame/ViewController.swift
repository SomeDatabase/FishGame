...
class FindFish: UIViewController {
    ...
    func setupgame()
    {
        ...
        FishHelp.contentMode = .scaleAspectFit
    }
...
class FishPuzzle: UIViewController {
    ...
    func initFishData()
    {
        ...
        let rnbwTroutHints = ["I have a pink stripe on my body","I primarily live in clear-water lakes throughout Michigan","When I grow older, I eat smallfish, but I primarily eat insects"]
        let stlhdTroutHints = ["I am born in rivers, but spend most of my life in the great lakes","My life expectancy is 4 to 6 years","You can find me in the summer time in scumlines"]
        let wllyHints = ["I spawn in rock shoals","I am a popular choice for sport fishing because I feed all year round","I am a greedy predator. I eat many small kinds of fish, such as a bass, perch, sunfish, pike, and trout"]
        var fishNum = 0
        var fish2 = 0
        var fish3 = 0
